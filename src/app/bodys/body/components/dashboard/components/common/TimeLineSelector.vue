  ...
  data () {
    return {
      ...
      rangeData: [
        ...
        {type: 'h', value: 13, hasPoint: false},
        {type: 'h', value: 12, hasPoint: true},
        {type: 'h', value: 11, hasPoint: false},
        {type: 'h', value: 10, hasPoint: true},
        {type: 'h', value: 9, hasPoint: false},
        {type: 'h', value: 8, hasPoint: true},
        {type: 'h', value: 7, hasPoint: false},
        {type: 'h', value: 6, hasPoint: true},
        {type: 'h', value: 5, hasPoint: false},
        {type: 'h', value: 4, hasPoint: true},
        {type: 'h', value: 3, hasPoint: false},
        {type: 'h', value: 2, hasPoint: true},
        {type: 'h', value: 1, hasPoint: true},
        {type: 'm', value: 30, hasPoint: true},
        {type: 'm', value: 10, hasPoint: true},
        {type: 'now', value: 1, hasPoint: true}
      ],
...
.chart_realtime_sub_tag .before24h {margin-left:0px !important;}
