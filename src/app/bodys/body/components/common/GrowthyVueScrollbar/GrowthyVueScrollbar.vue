    ...
    <div
      ...
      :style="{
        ...
        <growthy-vertical-scrollbar
          ...
          :on-drag-vertical="onDragVertical"
          :no-use-vertical-bar="noUseVerticalBar">
        </growthy-vertical-scrollbar>

        <growthy-horizontal-scrollbar
          v-if="ready"
          ...
          :on-dragging="handleScrollbarDragging"
          :on-stop-drag="handleScrollbarStopDrag"
          :on-drag-horizontal="onDragHorizontal"
          :no-use-horizontal-bar="noUseHorizontalBar"
          :classesHorizontalBar="classesHorizontalBar">
        </growthy-horizontal-scrollbar>
...
<script>
  ...
  import GrowthyVerticalScrollbar from './GrowthyVerticalScrollbar.vue'
  import GrowthyHorizontalScrollbar from './GrowthyHorizontalScrollbar.vue'

  export default {

    props: {
      classes: String,
      classesHorizontalBar: String,
      styles: Object,
      speed: {
        type: Number,
        default: 53
      ...
      onDragVertical: Function,
      onDragHorizontal: Function,
      noUseHorizontalBar: {
        type: Boolean,
        default: false
      },
    ...
    components: {
      GrowthyVerticalScrollbar,
      GrowthyHorizontalScrollbar
    },
